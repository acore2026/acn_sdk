...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the initiator side of the ACN task demo.")
...
def main() -> None:
    ...
    push_discover_result(initiator_agent_id=initiator_id, collaborator_ids=[collaborator_agent_id])
    time.sleep(0.2)
    ...
    push_subscribe_track(
        subscriber_agent_id=collaborator_agent_id,
